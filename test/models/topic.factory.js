(function(module, inject, angular) {
  ...
  describe("Model Service - $topic", function() {
    var model, config;
    ...
    describe("Query Scope - sorted_by_name", function() {
      ...
      describe("Relationship - Has Many - HealthcareProviderContent", function() {

        it("should have a method to get its contained instances array", function() {
          var instance = model.create({
            id: "1"
          });
          instance.$related.healthcareprovidercontents(function(results) {
