(function(module, inject, angular) {
  ...
  describe("Model Service - $clinicianCode", function() {
    var model, config;
    ...
    beforeEach(inject(function($injector) {
      ...
      model = $injector.get("$clinicianCode");
    ...
    describe("Query Scope - sorted_by_name", function() {
      ...
      describe("Relationship - Has Many - ClinicianBlockRandomizer", function() {

        it("should have a method to get its contained instances array", function() {
          var instance = model.create({
            id: "1"
          });
          instance.$related.clinicianblockrandomizers(function(results) {
      ...
      describe("Relationship - Has Many - User", function() {

        it("should have a method to get its contained instances array", function() {
          var instance = model.create({
            id: "1"
          });
          instance.$related.users(function(results) {
            expect(results).to.be.an.instanceof(Array);
          });
        });
